...
Na Rysunku \ref{fig:application-diagram} przedstawiono wizualizację ekranu generatora wraz z układem jego funkcjonalności.

% TP: TODO: dla kompletności pokażcie też zrzut ekranu z GUI
